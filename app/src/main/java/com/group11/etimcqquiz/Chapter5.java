...
//        backgroundMusic.start();
        ...
        //        Question 02
        list.add(new QuestionModel
                (       "Ethical Hacking will allow to ..... all the massive security breaches",
                        "Strengths",
                        "Weakness",
                        "Strengths & Weakness",
                        "None of these",
        ...
        //        Question 05
        list.add(new QuestionModel
                (       "The intent of ethical hacker is to discover vulnerabilities from a ..... point of view to better secure system.",
                        "Victims",
                        "Attackers",
                        "Both",
                        "None of these",
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position == list.size()) {
                    Intent scoreintent = new Intent(Chapter5.this, ScoreActivity.class);
                    finish();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Chapter5.this,HomeActivity.class);
