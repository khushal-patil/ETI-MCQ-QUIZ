...
//        backgroundMusic.start();
        ...
        //        Question 03
        list.add(new QuestionModel
                (       "___________is well established science where various contribution have been made",
                        "Forensic",
                        "Crime",
                        "Cyber Crime",
                        "Evidence",
        ...
        //        Question 04
        list.add(new QuestionModel
                (       "_______can makes or breaks investigation.",
                        "Crime",
                        "Security",
                        "Digital Forensic",
                        "Evidence",
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position == list.size()) {
                    Intent scoreintent = new Intent(Chapter4.this, ScoreActivity.class);
                    finish();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Chapter4.this,HomeActivity.class);
