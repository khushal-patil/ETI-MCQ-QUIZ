...
//        backgroundMusic.start();
        ...
        list.add(new QuestionModel
                (       "What are UTXOs in a Bitcoin Blockchain?",
                        ...
                        "These are transaction output that has ben expended",
                        "These form the input and output for transactions",
        ...
        //        Question 05
        list.add(new QuestionModel
                (       "Blockchains are store data in the form of?",
                        "Lines",
                        "Circle",
                        "Blocks",
                        "None of above",
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position == list.size()) {
                    Intent scoreintent = new Intent(Chapter3.this, ScoreActivity.class);
                    finish();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Chapter3.this,HomeActivity.class);
